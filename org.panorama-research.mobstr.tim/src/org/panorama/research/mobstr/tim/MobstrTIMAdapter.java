...
public class MobstrTIMAdapter extends AbstractTraceabilityInformationModelAdapter implements ITraceabilityInformationModelAdapter {
	...
	public Collection<EClass> getAvailableTraceTypes(List<EObject> selection) {
		...
		if (selection.size() > 1) {
			...
			traceTypes.add(TimPackage.eINSTANCE.getHasFailureMode());
			...
			traceTypes.add(TimPackage.eINSTANCE.getReferencesAsTopLevelEvent());
			traceTypes.add(TimPackage.eINSTANCE.getRefersToAnalysisResult());
